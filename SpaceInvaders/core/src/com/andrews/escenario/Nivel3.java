...
public class Nivel3 extends AbstractScreen {
	...
	public synchronized void render(float delta) {
		// System.out.println(listaEnemigos.getTamaño());
		...
		shot.disparado();
		if(tempo == 150) {
			listaEnemigos.reemplazar(3, 6, this);
		}
	...
	public void cambioAleatorio() {
		for(int i=0; i < listaEnemigos.getTamaño(); i++) {
			if(listaEnemigos.getDato(i).getTipoEnemigo().equals("boss")) {
				...
				listaEnemigos.reemplazar(random, i, this);
				break;
			}
		}
	}
