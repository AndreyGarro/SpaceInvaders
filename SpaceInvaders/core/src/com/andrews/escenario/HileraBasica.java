...
public class HileraBasica extends AbstractScreen {
	 ...
	 * 
	 * @param main
	 *            objeto de tipo GameMain para inicializar el constructor de la
	 *            super clase.
	 * @param listaEnemigos
	 *            lista de los enemigos a mostrar en pantalla.e
	 */
	@SuppressWarnings("unchecked")
	public HileraBasica(GameMain main, ArrayList<AbstractScreen> listaHileras, Nivel nivel) {
		super(main);
		this.tipo = "Basica";
